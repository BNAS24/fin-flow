"use client";
import { FinancialFlowCalendar } from "@/_components/calendar/Calendar";
import { SelectedDayPanel } from "@/_components/calendar/DaySelectedPanel";
import {
  FinancialDecisionsMockData,
  FinancialGoalsMockData,
  LineChartMockDataset,
} from "@/_data/test/core/mock-data";
import {
  createBalanceByDate,
